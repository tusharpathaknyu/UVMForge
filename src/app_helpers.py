"""
Helper functions for UVMForge app
...
Generated by UVMForge - https://uvmforge.app
...
<html>
<head>
    <title>{module_name} UVM Testbench - UVMForge</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="meta">
            <span class="badge">Generated by UVMForge</span>
            <span class="badge">{datetime.now().strftime("%Y-%m-%d %H:%M")}</span>
        </div>
        <pre><code>{code.replace("<", "&lt;").replace(">", "&gt;")}</code></pre>
        <div class="footer">
            Generated by <a href="https://uvmforge.app">UVMForge</a> - UVM Testbench Generator
        </div>
    </div>
</body>
</html>'''
