...
module spi_controller_spi_top_tb;
    
    import uvm_pkg::*;
    import spi_controller_spi_pkg::*;
    ...
    initial begin
        ...
        `ifdef QUESTA
            $wlfdumpvars(0, spi_controller_spi_top_tb);
        `endif
        
        // Generic VCD dumping
        `ifdef DUMP_VCD
            $dumpfile("spi_controller_spi.vcd");
            $dumpvars(0, spi_controller_spi_top_tb);
        `endif
...
endmodule : spi_controller_spi_top_tb